...
namespace Ecommerce.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProduto,Quantidade,Valor,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProduto,Quantidade,Valor,CategoriaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
